...
import json
from config import IMAGE_PATH, IMAGE_PROMOT, LAYOUT_PROMPT_TEMPLATE, Constraints, Sample_code
...
def main():
    ...
    image_description = get_image_description(encoded_image, IMAGE_PROMOT)
